...
document.getElementById('ascend-confirm').addEventListener('click', () => {
  ...
  replaceState(Object.assign(defaultState(), carry));
...
if (load()) {
  // Offline gain — applied here because rate() depends on systems we don't
  // import inside state.js. Cap by Lazy-pantheon-bumped offline cap.
